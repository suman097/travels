    ...
    <div class="page-content">
        ...
        <div id="portlet-config" class="modal hide">
            <div class="modal-header">
                ...
                <h3>Show Flight Class</h3>
            </div>
            <div class="modal-body">
                <p>Show All Flight Class</p>
            </div>
        </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <h3 class="page-title">
                        Flight Class <small>Show All Flight Class</small>
                    </h3>
                    <ul class="breadcrumb">
                        <li>
                            <i class="icon-home"></i>
                        ...
                        <li><a href="">Show All Flight Class</a></li>
                    </ul>
                ...
                <div class="span12">
                    ...
                    <div class="portlet box light-grey">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-globe"></i>Show All Flight Class</div>
                            <div class="tools">
                                ...
                                <tbody>
                                    ...
                                    if (!empty($types)) {
                                        ...
                                        foreach ($types as $type) {
                                            ...
                                            <tr >
                                                <td><?php echo $c; ?></td>
                                                <td><?php echo $type->flight_class; ?></td>
                                                <td class="center" id="status">
                                                    <?php
                                                    if ($type->status == "1") {
                                                        ?>
                                                        <span style="margin-left:35px;" class="status_<?php echo $type->id; ?>" onclick="return changeStatus(<?php echo $type->id; ?>, 'flight_class');"> 
                                                    ...
                                                    <?php } ?>                                    </td>
                                                <td style="width:70px;">
                                                    <a href="<?php echo base_url('flight-class/flight_class/editFlightClass') . '/' . $type->id; ?>" title="edit"><img src = "<?php echo base_url() . 'assets/img/edit.png' ?>" alt="Edit" height="30" width="30"></a>
                                                    <a href="<?php echo base_url('common/isDeleted'); ?>/<?php echo $type->id; ?>/flight_class/flight_class/viewFlightClass/flight-class" title="delete"><img src = "<?php echo base_url() . 'assets/img/delete.png' ?>" alt="Delete" height="30" width="30"></a>
                                                </td>
                                            </tr>
