			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						<h3 class="page-title">
							Flight Class
							<small>Edit Flight Class from super admin</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
							...
							<li><a href="">Edit Flight Class</a></li>
						</ul>
					</div>
				</div>
				<!-- END PAGE HEADER-->
					...
					<div class="span12">
								...
								<div class="tab-pane active" id="tab_1">
									<div class="portlet box blue">
										<div class="portlet-title">
											<div class="caption"><i class="icon-reorder"></i>Flight Class</div>
											<div class="tools">
                      ...
                      <div class="alert alert-warning" style = "display: none;">
                        <strong>Warning!</strong> Indicates a warning that might need attention.
											...
											<!-- BEGIN FORM-->
											<?= form_open_multipart( '', array('class' => 'horizontal-form'), array('flight_id' => $flight->id) ); ?>
                          <h3 class="form-section">Flight Class</h3>
                          <div class="row-fluid">
                              <div class="span6 ">
                                  <div class="control-group">
                                      <?= form_label('Flight Class', 'flight_class', array( 'class' => 'control-label' )); ?>
                                      <div class="controls">
                                          <?php
                                              $attributes = array(
                                                          'name'        => 'flight_class',
                                          ...
                                          ?>
                                          <?= form_error( 'flight_class', '<span class = "req">', '</span>'); ?>
                                      </div>
                                  </div>
                              </div>
                          </div>
                                  ...
                                  <div class="control-group">
                                      ...
                                      <div class="controls">
                                          <?php
                                              ...
                                              echo form_dropdown('status', $options, $flight->status, array( 'class' => 'm-wrap span12' ));
                                          ?>
                                      </div>
                                  </div>
                              </div>
