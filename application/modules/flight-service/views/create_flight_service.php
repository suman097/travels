			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						<h3 class="page-title">
							Flight Services
							<small>Insert Flight Services from super admin</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
							...
							<li><a href="">Insert Flight Services</a></li>
						</ul>
					</div>
				</div>
				<!-- END PAGE HEADER-->
                          ...
                          <div class="row-fluid">
                              <div class="span6 ">
                                  <div class="control-group">
                                      <?= form_label('Flight Services', 'flight_service', array( 'class' => 'control-label' )); ?>
                                      <div class="controls">
                                          <?php
                                              $attributes = array(
                                                          'name'        => 'flight_service',
