				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="">Edit Flight Service</a></li>
						</ul>
					</div>
				</div>
				<!-- END PAGE HEADER-->
					...
					<div class="span12">
								...
								<div class="tab-pane active" id="tab_1">
									<div class="portlet box blue">
										<div class="portlet-title">
											<div class="caption"><i class="icon-reorder"></i>Flight Services</div>
											<div class="tools">
                      ...
                      <div class="alert alert-warning" style = "display: none;">
                        <strong>Warning!</strong> Indicates a warning that might need attention.
                          ...
                          <h3 class="form-section">Flight Services</h3>
                          <div class="row-fluid">
                              <div class="span6 ">
                                  <div class="control-group">
                                      <?= form_label('Flight Service', 'flight_service', array( 'class' => 'control-label' )); ?>
                                      <div class="controls">
                                          <?php
                                              $attributes = array(
                                                          'name'        => 'flight_service',
                                                          'class' => 'm-wrap span12',
                                                          'id' => 'flight_service',
                                                          'value' => $flight->flight_service,
                                                        );
                                              echo form_input($attributes);
                                          ?>
                                          <?= form_error( 'flight_service', '<span class = "req">', '</span>'); ?>
                                      </div>
                                  </div>
                              </div>
                          </div>
