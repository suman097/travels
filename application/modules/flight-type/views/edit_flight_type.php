			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						<h3 class="page-title">
							Flight Type
							<small>Edit Flight Type from super admin</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
							...
							<li><a href="">Edit Flight Type</a></li>
						</ul>
					</div>
				</div>
				<!-- END PAGE HEADER-->
					...
					<div class="span12">
								...
								<div class="tab-pane active" id="tab_1">
									<div class="portlet box blue">
										<div class="portlet-title">
											<div class="caption"><i class="icon-reorder"></i>Flight Type</div>
											<div class="tools">
                      ...
                      <div class="alert alert-warning" style = "display: none;">
                        <strong>Warning!</strong> Indicates a warning that might need attention.
                          ...
                          <h3 class="form-section">Flight Type</h3>
                          <div class="row-fluid">
                              <div class="span6 ">
                                  <div class="control-group">
                                      <?= form_label('Flight Type', 'flight_type', array( 'class' => 'control-label' )); ?>
                                      <div class="controls">
                                          <?php
                                              $attributes = array(
                                                          'name' => 'flight_type',
                                          ...
                                          ?>
                                          <?= form_error( 'flight_type', '<span class = "req">', '</span>'); ?>
                                      </div>
                                  </div>
                              </div>
                          </div>
