			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						<h3 class="page-title">
							Flight Type
							<small>Edit Trip Type from super admin</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
					...
					<div class="span12">
								...
								<div class="tab-pane active" id="tab_1">
									<div class="portlet box blue">
										<div class="portlet-title">
											<div class="caption"><i class="icon-reorder"></i>Trip Type</div>
											<div class="tools">
                      ...
                      <div class="alert alert-warning" style = "display: none;">
                        <strong>Warning!</strong> Indicates a warning that might need attention.
											...
											<!-- BEGIN FORM-->
											<?= form_open_multipart( '', array('class' => 'horizontal-form'), array('trip_id' => $trip->id) ); ?>
                          <h3 class="form-section">Trip Type</h3>
                          <div class="row-fluid">
                              <div class="span6 ">
                                  <div class="control-group">
                                      <?= form_label('Trip Type', 'trip_type', array( 'class' => 'control-label' )); ?>
                                      <div class="controls">
                                          <?php
                                              $attributes = array(
                                                          'name'        => 'trip_type',
                                          ...
                                          ?>
                                          <?= form_error( 'trip_type', '<span class = "req">', '</span>'); ?>
                                      </div>
                                  </div>
                              </div>
                          </div>
                                  ...
                                  <div class="control-group">
                                      ...
                                      <div class="controls">
                                          <?php
                                              ...
                                              echo form_dropdown('status', $options, $trip->status, array( 'class' => 'm-wrap span12' ));
                                          ?>
                                      </div>
                                  </div>
                              </div>
