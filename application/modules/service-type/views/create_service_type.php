			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						<h3 class="page-title">
							Services Type
							<small>Insert Services Type from super admin</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
							...
							<li><a href="">Insert Services Type</a></li>
						</ul>
					</div>
				</div>
				<!-- END PAGE HEADER-->
				...
				<div class="row-fluid">
					<div class="span12">
								...
								<div class="tab-pane active" id="tab_1">
									<div class="portlet box blue">
										<div class="portlet-title">
											<div class="caption"><i class="icon-reorder"></i>Services Type</div>
											<div class="tools">
                      ...
                      <?= form_open_multipart( '', array('class' => 'horizontal-form') ); ?>
                          <h3 class="form-section">Services Type</h3>
                          <div class="row-fluid">
                              <div class="span6 ">
