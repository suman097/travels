    ...
    <div class="page-content">
        ...
        <div id="portlet-config" class="modal hide">
            <div class="modal-header">
                ...
                <h3>Show Service Type</h3>
            </div>
            <div class="modal-body">
                <p>Show All Service Type</p>
            </div>
        </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <h3 class="page-title">
                        Service Type <small>Show All Service Type</small>
                    </h3>
                    <ul class="breadcrumb">
                        <li>
                            <i class="icon-home"></i>
                        ...
                        <li><a href="">Show All Service Type</a></li>
                    </ul>
                ...
                <div class="span12">
                    ...
                    <div class="portlet box light-grey">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-globe"></i>Show All Service Type</div>
                            <div class="tools">
                                        ...
                                        foreach ($types as $type) {
                                            ...
                                            <tr >
                                                ...
                                                <td class="center" id="status">
                                                    ...
                                                    if ($type->status == "1") {
                                                        ?>
                                                        <span style="margin-left:35px;" class="status_<?php echo $type->id; ?>" onclick="return changeStatus(<?php echo $type->id; ?>, 'service_type');"> 
                                                    ...
                                                    <?php } ?>                                    </td>
                                                <td style="width:70px;">
                                                    <a href="<?php echo base_url('service-type/service_type/editServiceType') . '/' . $type->id; ?>" title="edit"><img src = "<?php echo base_url() . 'assets/img/edit.png' ?>" alt="Edit" height="30" width="30"></a>
                                                    <a href="<?php echo base_url('common/isDeleted'); ?>/<?php echo $type->id; ?>/service_type/service_type/viewServiceType/service-type" title="delete"><img src = "<?php echo base_url() . 'assets/img/delete.png' ?>" alt="Delete" height="30" width="30"></a>
                                                </td>
                                            </tr>
