        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <h3 class="page-title">
                        Country <small>Show All Country</small>
                    </h3>
                    <ul class="breadcrumb">
                        <li>
                            <i class="icon-home"></i>
                        ...
                        <li><a href="">Show All Country</a></li>
                    </ul>
                ...
                <div class="span12">
                    ...
                    <div class="portlet box light-grey">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-globe"></i>Show All Country</div>
                            <div class="tools">
                                        ...
                                        foreach ($countries as $country) {
                                            ...
                                            <tr >
                                                ...
                                                <td class="center" id="status">
                                                    ...
                                                    if ($country->status == "1") {
                                                        ?>
                                                        <span style="margin-left:35px;" class="status_<?php echo $country->id; ?>" onclick="return changeStatus(<?php echo $country->id; ?>, 'country');"> 
                                                    ...
                                                    <?php } ?>                                    </td>
                                                <td style="width:70px;">
                                                    <a href="<?php echo base_url('country/country/editCountry') . '/' . $country->id; ?>" title="edit"><img src = "<?php echo base_url() . 'assets/img/edit.png' ?>" alt="Edit" height="30" width="30"></a>
                                                    <a href="<?php echo base_url('common/isDeleted'); ?>/<?php echo $country->id; ?>/country/country/viewCountry/country" title="delete"><img src = "<?php echo base_url() . 'assets/img/delete.png' ?>" alt="Delete" height="30" width="30"></a>
                                                </td>
                                            </tr>
