			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						<h3 class="page-title">
							Country
							<small>Edit Country from super admin</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
					...
					<div class="span12">
                      ...
                      <div class="alert alert-warning" style = "display: none;">
                        <strong>Warning!</strong> Indicates a warning that might need attention.
											...
											<!-- BEGIN FORM-->
											<?= form_open_multipart( '', array('class' => 'horizontal-form'), array('country_id' => $country->id) ); ?>
                          <h3 class="form-section">Country</h3>
                          <div class="row-fluid">
                              <div class="span6 ">
                                  <div class="control-group">
                                      ...
                                      <div class="controls">
                                          ...
                                          ?>
                                          <?= form_error( 'country', '<span class = "req">', '</span>'); ?>
                                      </div>
                                  </div>
                              </div>
                          </div>
                                  ...
                                  <div class="control-group">
                                      ...
                                      <div class="controls">
                                          <?php
                                              ...
                                              echo form_dropdown('status', $options, $country->status, array( 'class' => 'm-wrap span12' ));
                                          ?>
                                      </div>
                                  </div>
                              </div>
