        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <h3 class="page-title">
                        Location <small>Show All Location</small>
                    </h3>
                    <ul class="breadcrumb">
                        <li>
                            <i class="icon-home"></i>
                        ...
                        <li><a href="">Show All Location</a></li>
                    </ul>
                ...
                <div class="span12">
                    ...
                    <div class="portlet box light-grey">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-globe"></i>Show All Location</div>
                            <div class="tools">
                                            ...
                                            <tr >
                                                ...
                                                <td class="center" id="status">
                                                    ...
                                                    if ($location->status == "1") {
                                                        ?>
                                                        <span style="margin-left:35px;" class="status_<?php echo $location->id; ?>" onclick="return changeStatus(<?php echo $location->id; ?>, 'location');"> 
                                                    ...
                                                    <?php } ?>                                    </td>
                                                <td style="width:70px;">
                                                    <a href="<?php echo base_url('location/location/editLocation') . '/' . $location->id; ?>" title="edit"><img src = "<?php echo base_url() . 'assets/img/edit.png' ?>" alt="Edit" height="30" width="30"></a>
                                                    <a href="<?php echo base_url('common/isDeleted'); ?>/<?php echo $location->id; ?>/location/location/viewLocation/location" title="delete"><img src = "<?php echo base_url() . 'assets/img/delete.png' ?>" alt="Delete" height="30" width="30"></a>
                                                </td>
                                            </tr>
