			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						<h3 class="page-title">
							Location
							<small>Insert Location from super admin</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
							...
							<li><a href="">Insert Location</a></li>
						</ul>
					</div>
				</div>
				<!-- END PAGE HEADER-->
                          ...
                          <div class="row-fluid">
                              <div class="span6 ">
                                  <div class="control-group">
                                      ...
                                      <div class="controls">
                                          <?= form_dropdown('service_type', $services, 1, array( 'class' => 'm-wrap span12' )); ?>
                                      </div>
                                  </div>
                              </div>
                          </div>
                          <div class="row-fluid">
                              <div class="span6 ">
                                  <div class="control-group">
                                      ...
                                      <div class="controls">
                                          <?= form_dropdown('location_type', $types, 1, array( 'class' => 'm-wrap span12', 'onchange' => 'onChangeSelectCountryByLocationType(this.value);' )); ?>
                                      </div>
                                  </div>
                              </div>
                          </div>
                              ...
                              <div class="span6 ">
                                  <div class="control-group">
                                      ...
                                      <div class="controls" id = "location_country">
                                          <?= form_dropdown('country_id', $countries, 1, array( 'class' => 'm-wrap span12', 'onchange' => 'onChangeStateByCountry(this.value);' )); ?>
                                      </div>
                                  </div>
                              </div>
                          </div>
                              ...
                              <div class="span6 ">
                                  <div class="control-group">
                                      ...
                                      <div class="controls" id = "location_state">
                                          <?= form_dropdown('state_id', $states, 1, array( 'class' => 'm-wrap span12' )); ?>
                                      </div>
                                  </div>
                              </div>
                          </div>
