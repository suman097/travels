        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <h3 class="page-title">
                        State <small>Show All State</small>
                    </h3>
                    <ul class="breadcrumb">
                        <li>
                            <i class="icon-home"></i>
                ...
                <div class="span12">
                    ...
                    <div class="portlet box light-grey">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-globe"></i>Show All State</div>
                            <div class="tools">
                                        ...
                                        foreach ($states as $state) {
                                            ...
                                            <tr >
                                                ...
                                                <td class="center" id="status">
                                                    ...
                                                    if ($state->status == "1") {
                                                        ?>
                                                        <span style="margin-left:35px;" class="status_<?php echo $state->id; ?>" onclick="return changeStatus(<?php echo $state->id; ?>, 'state');"> 
                                                    ...
                                                    <?php } ?>                                    </td>
                                                <td style="width:70px;">
                                                    <a href="<?php echo base_url('state/state/editState') . '/' . $state->id; ?>" title="edit"><img src = "<?php echo base_url() . 'assets/img/edit.png' ?>" alt="Edit" height="30" width="30"></a>
                                                    <a href="<?php echo base_url('common/isDeleted'); ?>/<?php echo $state->id; ?>/state/state/viewState/state" title="delete"><img src = "<?php echo base_url() . 'assets/img/delete.png' ?>" alt="Delete" height="30" width="30"></a>
                                                </td>
                                            </tr>
