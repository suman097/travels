			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						<h3 class="page-title">
							State
							<small>Edit State from super admin</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
					...
					<div class="span12">
                      ...
                      <div class="alert alert-warning" style = "display: none;">
                        <strong>Warning!</strong> Indicates a warning that might need attention.
											...
											<!-- BEGIN FORM-->
											<?= form_open_multipart( '', array('class' => 'horizontal-form'), array('state_id' => $state->id) ); ?>
                          <h3 class="form-section">State</h3>
                          <div class="row-fluid">
                              <div class="span6 ">
                                  <div class="control-group">
                                      <?= form_label('Country', 'country', array( 'class' => 'control-label' )); ?>
                                      <div class="controls">
                                          <?= form_dropdown('country_id', $countries, $state->country_id, array( 'class' => 'm-wrap span12' )); ?>
                                      </div>
                                  </div>
                              </div>
                          </div> 
                              ...
                              <div class="span6 ">
                                  <div class="control-group">
                                      ...
                                      <div class="controls">
                                          ...
                                          ?>
                                          <?= form_error( 'state', '<span class = "req">', '</span>'); ?>
                                      </div>
                                  </div>
                              </div>
                          </div>
                                  ...
                                  <div class="control-group">
                                      ...
                                      <div class="controls">
                                          <?php
                                              ...
                                              echo form_dropdown('status', $options, $state->status, array( 'class' => 'm-wrap span12' ));
                                          ?>
                                      </div>
                                  </div>
                              </div>
